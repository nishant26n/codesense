...
const features: Feature[] = [
  ...
  },
  {
    ...
    color: 'from-brand-500/20 to-brand-600/5 border-brand-500/15 text-brand-400',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    color: 'from-green-500/20 to-green-600/5 border-green-500/15 text-green-400',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    color: 'from-purple-500/20 to-purple-600/5 border-purple-500/15 text-purple-400',
  },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden pt-20 pb-32">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed mb-10">
            CodeSense analyzes your code for bugs, performance issues, and security vulnerabilities in seconds — powered by GPT-4o.
          </p>

          <div className="flex items-center justify-center gap-4 flex-wrap">
            {user ? (
              <Link to="/dashboard" className="btn-primary text-base px-8 py-3.5 shadow-xl shadow-brand-900/50">
                Go to Dashboard →
              </Link>
            ) : (
              <>
                <Link to="/register" className="btn-primary text-base px-8 py-3.5 shadow-xl shadow-brand-900/50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-24">
        <div className="text-center mb-14">
          <h2 className="text-3xl font-bold text-white mb-3">Everything you need to write better code</h2>
          <p className="text-gray-500">Comprehensive AI analysis in one place</p>
        </div>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-24 text-center">
        <div className="glass-card p-12 bg-gradient-to-br from-brand-900/30 to-surface-800/30 border-brand-500/10">
          ...
          <p className="text-gray-400 mb-8">Join developers who ship with confidence.</p>
          {!user && (
